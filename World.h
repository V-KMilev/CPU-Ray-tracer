...
Hittable_list random_scene() {
	...
	world.add(make_shared<Sphere>(Point(0.0, 1000.5, -1.0), 1000.0, material_sphere_n));

	world.add(make_shared<Sphere>(Point(-17.0, -6.5, -10.0), 7.5, mertial_sphere_i_1));
	...
	world.add(make_shared<Sphere>(Point(+10.0, -2.5, -35.0), 3.5, mertial_sphere_i_0));
